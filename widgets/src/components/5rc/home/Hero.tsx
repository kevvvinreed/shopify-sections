...
const Hero: React.FC<HeroProps> = ({ scrollIndex, setScrollIndex }) => {
    ...
    <>
      <style>
        {`
            ...
            .fadeOffScreen {
                animation: fadeOffScreenAnimation ${config.scrollAnimationTimingMs}ms ease-in forwards;
            }
            .fadeInScreen {
                animation: fadeInScreenAnimation ${config.scrollAnimationTimingMs}ms ease-out forwards;
            }
              
            .frc-landing__hero-container > *:not(.frc-landing__hero-overlay) {
                position: relative;
                z-index: 2;
            }
            @keyframes static {
